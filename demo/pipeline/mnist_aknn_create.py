...
from mnist_to_vectors import iter_train
...
if __name__ == "__main__":
    ...
    ap.add_argument("--es_host", default="http://localhost:9201",
    ...
    ap.add_argument("--aknn_dimensions", type=int, default=784)#1000)
    ...
    body = {
        ...
        "_id": "mnist_images",
        "_source": {
            "_aknn_description": "MNIST test aknn",
    ...
    if req.status_code != 200:
        print("Failed to delete index: %s" % json.dumps(req.json()))
