...
if __name__ == "__main__":
    ...
    ap.add_argument("--es_hosts", default="http://localhost:9201",
    ...
    body = {
        "_index": "mnist_images",
        "_type": "mnist_images",
        "_aknn_uri": "aknn_models/aknn_model/mnist_images",
        "_aknn_docs": [
    ...
    docs = iter_train()#args["features_src"], count, True)
    ...
    for doc, lbl in docs:
        ...
        for h, d in zip(es_hosts, chunked(docs_batch, args["batch_size"])):
            ...
            print("Posting to url %s" % (post_url,))
